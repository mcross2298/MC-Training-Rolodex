  ...
  const SLIDES = [
    ...
    },
    {
      ...
      steps:[
        ...
        {tx:"A <b>🧩 Cluster</b> exercise breaks each working set into mini-sets — the Log Sets row shows a rep bubble per mini-set (e.g. <b>5 + 5 + 5</b>) instead of one box, prefilled with the target so you only edit the ones that came up short (like a <b>5 + 5 + 3</b> last mini-set). Tap the <b>🧩 Cluster</b> badge or note on the card itself to adjust the whole breakdown — your split saves the moment you hit Save, and the rep bubbles pick it up the next time you open the workout. It's your own personal adjustment and never changes what the program publishes."},
